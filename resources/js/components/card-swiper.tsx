...
export function CardSwiper({cmsmodule}:messageProbs){
                ...
                >
                    {cmsmodule.custom_module_detail.map((message,index) => (
                        <SwiperSlide key={index+1}>
                            <div className="bg-white p-3 rounded-lg shadow-md border border-gray-200 h-full flex flex-col justify-between">
                                <p className="text-zinc-600 text-base leading-relaxed mb-6">"{message.detail}"</p>
