...
export const NextButton: React.FC<ButtonProps> = ({ children, ...rest }) => (
  <button className="embla__button embla__button--next" type="button" {...rest}>
    <svg className="embla__button__svg" viewBox="0 0 532 532">
      <path
        fill="currentColor"
...
export const useSelectedSnapDisplay = (
  ...
  const updateScrollSnapState = useCallback((embla: EmblaCarouselType) => {
...
// --- SelectedSnapDisplay Component ---
type SnapDisplayProps = {
  selectedSnap: number
  snapCount: number
}

export const SelectedSnapDisplay: React.FC<SnapDisplayProps> = ({
  selectedSnap,
  snapCount
}) => (
