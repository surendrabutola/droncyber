        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="w-full p-10">
                <div className="mb-6 flex flex-row justify-between">
                    <h1 className="text-xl font-bold">Info Cards</h1>
                    <Link
                        href={route('infocards.create')}
